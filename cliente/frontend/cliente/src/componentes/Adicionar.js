...
export default class Adicionar extends React.Component {
 ...
 getCep() {
  ...
  adicionar = e => {
    ...
    axios.post('http://localhost:8080/clientes?token=' + token, novoCliente).then(res => {
      if (res.data.erro) {
        Swal.fire({
          icon: 'error',
          title: 'Erro!',
        ...
        this.props.setEstaAdicionando(false);
        this.props.atualiza();

        Swal.fire({
          icon: 'success',
          title: 'Adicionado!',
          text: `${this.state.nome} foi adicionado com sucesso`,
          ...
          <h4>Novo Cliente</h4>
              ...
              <div style={{width: "380px", float:"right", display:"inline-grid", margin:"25px 0 0 0"}}>                
                <div style={{padding: "10px"}}>                                    
                  <div style={{width:"80%", padding:"0 5px", float:"left"}}>
                    <label style={{textAlign:"initial"}} htmlFor="uf">E-mail</label>
                    <input
                      style={{ height: 42 }}
                      type="email"
            ...
            <div style={{ marginTop: '30px' }}>
                  ...
                  <input
                    ...
                    type="button"
                    value="Cancelar"
                    onClick={() => this.props.setEstaAdicionando(false)}
                  />
            </div>
          </form>
        </div>
